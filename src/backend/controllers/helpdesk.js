(function (module) {
    ...
    module.exports.talkSearch = talkSearch;
    module.exports.talkAdd = talkAdd;
    module.exports.messageAdd = messageAdd;
    module.exports.messageGetAll = messageGetAll;
    module.exports.messageGetUnread = messageGetUnread;


    module.exports.talkGetById = talkGetById;
    module.exports.talkSavedByEmployee = talkSavedByEmployee;
    module.exports.customerSearch = customerSearch;
    module.exports.employeeSearch = employeeSearch;
    ...
    function talkAdd(req, params, cb) {
        cb(null, crudAjaxOpts.ajax.talkAdd(req, params, cb));
    }
    function messageAdd(req, params, cb) {
        cb(null, crudAjaxOpts.ajax.messageAdd(req, params, cb));
    }
    function messageGetAll(req, params, cb) {
        cb(null, crudAjaxOpts.ajax.messageGetAll(req, params, cb));
    }
    function messageGetUnread(req, params, cb) {
        cb(null, crudAjaxOpts.ajax.messageGetUnread(req, params, cb));
    }

    function talkGetById(req, params, cb) {
        cb(null, crudAjaxOpts.ajax.talkGetById(req, params, cb));
    }
    function talkSavedByEmployee(req, params, cb) {
        cb(null, crudAjaxOpts.ajax.talkSavedByEmployee(req, params, cb));
    }
    function customerSearch(req, params, cb) {
        cb(null, crudAjaxOpts.ajax.customerSearch(req, params, cb));
    }
    function employeeSearch(req, params, cb) {
        cb(null, crudAjaxOpts.ajax.employeeSearch(req, params, cb));
    }
