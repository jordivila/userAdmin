...
function ($, jqUI, clientApp, P, crudModule, crudAjaxOpts, helpdeskUrls) {
    ...
    clientApp.view = {
        main: function () {
            //ui-helpdesk-talks-subject-next

            var $mainBox = jQuery('div.ui-helpdesk-talks-subject-container:first');
            ...
            var showDataResultOK = function (dataResult) {
                ...
                clientApp.template.loadByUrl('../' + helpdeskUrls.message(dataResult.data.editData.id));
            };
